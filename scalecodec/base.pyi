...
class ScaleDecoder(ABC, Generic[T_co]):
    ...
    def process_type(self, type_string: Union[str, dict], **kwargs: Any) -> "ScaleType[Any]": ...
...
class RuntimeConfigurationObject:
    ...
    def get_decoder_class(self, type_string: Union[str, dict]) -> Optional[Type[ScaleType[Any]]]: ...
